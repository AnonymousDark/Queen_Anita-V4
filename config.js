...
global.anitav4 = process.env.BOT_NAME || "PALCCOD_MD-𝐕𝟒";
global.ownername = process.env.OWNER_NAME || "Palccod";
global.packname = process.env.PACK_NAME || "PCOD-𝐕4";
global.author = process.env.AUTHOR || "pAlCcOd";
global.channelname = process.env.CHANNEL_NAME || "PALCCOD";
...
global.mess = {
    ...
    botAdmin: process.env.MESSAGE_BOT_ADMIN || '_*❗This Command Can Only Be Used When Owner Becomes Group Admin !*_',
    OnlyOwner: process.env.MESSAGE_OWNER || '_*❗Access Denied,Owner Only !*_',
    ...
    wait: process.env.MESSAGE_WAIT || '_*Chill...*_',
